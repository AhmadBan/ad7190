...
/* AD7190 GPIO */
#define AD7190_RDY_STATE		1
#define ADI_PART_CS_LOW			HAL_GPIO_WritePin(SPI1_NSS_GPIO_Port, SPI1_NSS_Pin, GPIO_PIN_RESET)
#define ADI_PART_CS_HIGH		HAL_GPIO_WritePin(SPI1_NSS_GPIO_Port, SPI1_NSS_Pin, GPIO_PIN_SET)
/* AD7190 Register Map */
